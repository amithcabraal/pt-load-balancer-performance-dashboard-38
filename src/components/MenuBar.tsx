      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-3">
          <div className="flex items-center space-x-4">
            ...
            <a
              href="https://us-east-1.console.aws.amazon.com/cloudfront/v3/home?region=us-east-1#/cache"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-1 text-blue-600 hover:text-blue-800"
            >
              <ExternalLink className="w-4 h-4" />
              <span>CloudFront Cache Stats</span>
            </a>
            <a
              href="https://us-east-1.console.aws.amazon.com/cloudfront/v3/home?region=us-east-1#/popular_urls"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-1 text-blue-600 hover:text-blue-800"
            >
              <ExternalLink className="w-4 h-4" />
              <span>CloudFront Popular Objects</span>
            </a>
            <a
              href="https://loadrunner-cloud-eur.saas.microfocus.com/results/?TENANTID=335176489&projectId=1"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-1 text-blue-600 hover:text-blue-800"
            >
              <ExternalLink className="w-4 h-4" />
              <span>LoadRunner Results</span>
            </a>
            <button
